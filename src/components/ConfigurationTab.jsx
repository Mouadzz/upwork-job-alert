...
const ConfigurationTab = ({ config, onConfigChange }) => {
      ...
      <div className="space-y-3">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-xs focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            placeholder="0"
          />
        </div>
        ...
        <div className="space-y-1">
          <label className="block text-xs text-gray-300">
            ...
            <span className="text-xs text-gray-500 ml-2">Min: 20</span>
          </label>
          <input
            type="text"
        ...
        <div className="space-y-1">
          <label className="block text-xs text-gray-300">
            ...
            <span className="text-xs text-gray-500 ml-2">0 = All</span>
          </label>
          <input
            type="text"
